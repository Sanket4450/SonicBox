...
export default {
  ...
  createPlaylist: async (
    ...
    try {
      ...
      const { _id, name, userId, image, description, isPrivate } =
        await playlistService.createPlaylist(token, input)
  ...
  createCategory: async (
    ...
    try {
      ...
      const { _id, name, image, description, parent_categoryId, playlists } =
        await categoryService.createCategory(token, input)
  ...
  updateSong: async (
    ...
    try {
      ...
      const { _id, name, albumId, fileURL, listens, artists } =
  ...
  updatePlaylist: async (
    ...
    try {
      ...
      const { _id, name, image, description, isPrivate } =
  ...
  updateCategory: async (
    ...
    try {
      ...
      const { _id, name, image, description, parent_categoryId } =
