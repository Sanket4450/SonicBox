...
export default {
  ...
  addRemoveLibraryPlaylist: async (
    _: any,
    { input }: addRemoveLibraryPlaylist,
    { token }: any,
    info: GraphQLResolveInfo
    ...
    try {
      ...
      validateSelection(
        info.fieldNodes[0].selectionSet,
        fields.addRemoveLibraryPlaylist
      )
  ...
  addRemoveLibraryArtist: async (
    _: any,
    { input }: addRemoveLibraryArtist,
    { token }: any,
    info: GraphQLResolveInfo
  ): Promise<{ isAdded: boolean }> => {
    try {
  ...
  addRemoveLibraryAlbum: async (
    _: any,
    { input }: addRemoveLibraryAlbum,
    { token }: any,
    info: GraphQLResolveInfo
  ): Promise<{ isAdded: boolean }> => {
    try {
